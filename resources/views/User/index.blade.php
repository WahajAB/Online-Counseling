                                        ...
                                        <li class="list-group-item">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    </svg>{{$result}}&nbsp&nbsp {{"($count reviews)"}}
                                                </div>
                                                <div>
                                                    <a href="{{ route('message_counselor', ['id' => $counselor->id]) }}" class="btn btn-success btn-sm text-center">{{ __('Message') }}</a>
                                                    <a href="{{ route('call', ['id' => $counselor->id]) }}" class="btn btn-success btn-sm text-center" style="margin-left: 1rem; width: 4rem;">{{ __('Call') }}</a>
                                                </div>
                                            </div>
                                        </li>
                                        @endforeach
