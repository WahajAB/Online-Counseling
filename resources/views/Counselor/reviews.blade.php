...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-11">
                <div class="card">
                    <div class="card-header text-center" style="font-size: 1.5rem; font-weight:700;">
                        {{ __('Your Reviews') }}</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        @endif
                        @php
                            $sortedReviews = $reviews->sortByDesc('createds_at');
                        @endphp
                                ...
                                <tbody>
                                    ...
                                    @foreach ($sortedReviews as $review)
                                        <tr class="align-middle">
                                            <td>{{ $review->id }}</td>
                                            <td><svg style="margin-top: -0.2rem;" width="18" height="18" viewBox="0 0 18 18"
